...
If you are not familiar with *asymptotic notation* for denoting the running time of an
algorithm, see [Problem 6](problem006.qmd#efficiency-of-algorithms) for a short introduction.
