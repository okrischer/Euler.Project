...
\usemintedstyle[go]{autumn}
\newminted[go]{go}{bgcolor=bgg}

\begin{document}
\definecolor{bgh}{rgb}{0.96,0.96,0.98}
\definecolor{bgg}{rgb}{0.95,0.98,0.95}
\title{Project Euler}
...
\begin{abstract}
  ...
  But, within a given language, the results have a relative meaning: if \mintinline{haskell}{someFunction} is 2.5 times slower than \mintinline{haskell}{anotherFunction} in the same language, then \mintinline{haskell}{anotherFunction} is indeed faster.
\end{abstract}
\tableofcontents
