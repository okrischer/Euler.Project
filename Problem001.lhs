...
If we define a function \mintinline{haskell}{triangular :: Int -> Int -> Int}, we can express the result like so:
...
Since \mintinline{haskell}{triangular} represents a closed formula, the runtime complexity of this algorithm is constant, thus $\Theta(1)$.
...
testProp n =
    n > 9 && n < 1000 ==> filterMultiples n == closedFormula n
\end{code}
